          ...
          <div className="space-y-4">
            <div className="flex gap-4">
              ...
              <textarea
                ...
                className="flex-1 bg-gray-50 rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-dahab-teal/20 resize-none h-24"
              />
            </div>
            ...
            {currentUser ? (
              <form onSubmit={handleCommentSubmit} className="relative">
                <input 
                  ...
                  className="w-full bg-gray-100 rounded-full pl-4 pr-12 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-dahab-teal/30"
                />
                <button 
                  type="submit" 
