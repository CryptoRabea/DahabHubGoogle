    ...
    <div className="space-y-12">
      ...
      <section>
        <div className="flex justify-between items-end mb-6">
          {/* Removed text-gray-800 to inherit global text color */}
          <h2 className="text-2xl font-bold">Explore {settings.appName.split(' ')[0]}</h2>
        </div>
      ...
      <section>
        <div className="flex justify-between items-end mb-6">
          <div>
             ...
             {/* Changed text-gray-500 to opacity-80 for better contrast on dark/light backgrounds */}
             <p className="opacity-80 text-sm mt-1">Don't miss out on these popular activities</p>
          </div>
